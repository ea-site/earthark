...
//      var f = path+x+'__';
  ...
  // newアイコン
  _NEWA:'data:image/gif;base64,'+
'R0lGODlhIAAQAOfbAP8AAP4DAv4GBP4GBf4HBv4JCP4PC/4QDP4gGP4iFv4lGP4pH/48M/0+LP1D'+
'MP1FMf1GM/1GOP1IOf1LO/1MPP1RO/xTPf1hTPxqSfxyTvxzVP1zXP13XvyIafyLavuQY/2PdvuS'+
'ZPuSZf2Ue/qZZv2diD3Y8vyvj/uygvu/ivnPh/nQiPrPmPvPpvnZl/3Xuvjdkvjgkvzct/zcvf3e'+
'wPrnr/rpsPrrsvbyfPXzfPbze/bzfPbzffbzfvbzf/fzf/fzgPb0fvfzhvfzh/b0hPb0hfb0hvf0'+
'hPb0h/f0hfb0iPf0hvf0h/f0iPf0iff0jvf0j/f0kPj0jvf0kff1ifj0kPf1jvf1j/f1kPf1kfj1'+
'j/f1kvj1kff1lvj1l/j1mPj1mfj1mvj1m/j1nPryuPj2l/j2mPj2mfj2mvj2m/j2oPj2ofj2ovn2'+
'oPj2pPj3ovn3oPj3pPj3pfn3o/n3pPn3pfzy0Pn3q/n3rPn3rfr2tPr3rPr3rfn4qfn4qvn4q/v2'+
'uvn4rvr4rvn4tPr4s/r4tPr4tfr4tvr4t/r4vPr5t/r5vPr5vvv5vPv5vfr5wPv5v/v5wPv5xfv5'+
'xvv5x/v6wPv6xfv6xvv6x/v6yPz6xvv6yfv6yvz6yfv6zvz6z/z60Pz60fz60vv70Pz7zvz70Pz7'+
'0fz70/z71/z72Pz72/372f372v373Pz82P381/382f382/383Pz84f384P384f384v384/385P38'+
'5f785P394f394v394/395P395f795P795f396v396/796v397f796/797P797f797v3+7f3+7v7+'+
'7P7+7f7+7v7+8/7+9P7+9f/+8/7+9v/+9P7+9//+9f/+9v/+9/7/9v7/+P//////////////////'+
'////////////////////////////////////////////////////////////////////////////'+
'/////////////////////////////////////////////////////yH5BAEKAP8ALAAAAAAgABAA'+
'AAj+AP8JNEGwoMGDCA8KHEjQBxAfEH/46DGxBw8eQS5qxLEjhw4cBQc6oeJESZOTSpggScmk5ZIl'+
'Q4wIWVLEiJEkRYgcMfGP4JafW7Jk4TKFy1AsWaJUiaIFyxUoUJ5AsSLFypMnBcekSSMmTZiuaMKI'+
'DYPmDJgzZs2Y+cLWTJkvXsp0ISinjps6AEjQmeMGQJw5AAIHZpNgxZsYAWCsUaEAjpo2BAUF4pMH'+
'QAMXeSrv4QMAz587d/5gEHFHhIAQdz5k8NPHD0FFiBApAsACgp5DAA4ZAmCot6FCKCwMcqDhAaEK'+
'KQgpJxgp0qNKAB556AAJACRGggM7IoOgxoEbBmziLADUaFEigpw4bdoEoBOlCC0AbMoEIBMmSpQw'+
'aZqwgcIkCRxccIkkllhC0CkIigKAKKHIwAAAppgCQCkRljIKKCMMMEIpIBBwAimfkOIJQa3IIksr'+
'AKgSSywlAMAKK9kBAAssNAAwwyovFGCHK6+gkkpBv+QSjC65+IILLsD44ksvt9zSC5O83GKLLbXM'+
'Ussus8xCC0E9JZPMMs40o0wzyCBzDDLFIMPMMccMwwwzxhgzTJzGCEMMMTz1RFA12mCDTTbXTDNN'+
'oNFYE8000SRqDTXQUPMMNNKEtFBClFbKpUABAQA7',
  // 読み込み中アイコン
  _READING: 'data:image/gif;base64,'+
    ...
    (function (){
      ...
      .fail(function(xhr, status, e){
          ...
          try{
            ...
            modal_open({url:null, text:'タイムアウト：再読込みしてください', width:'240', height:'0', align:'center',button:null,callback:null});
          }
      });
    })();
  },
...
/*
        if(!WRITE){
          $(e).append('<hr><li><a  id="hisbtn" href="javascript:void(0);" rel="nofollow" style="color:#0a0">投稿履歴</a></li>');
        }
*/
...
/*
        if(!WRITE){
          $('#hisbtn').click(function(e){
            $it._DF=0; wclose($('#slide_menu'), $('#dclose, #orgin'));
            var e = 0;
            $("#bp").find('div').each(function(){ if( $(this).is('#inhis') ) ++e; });
            if( !e ){
              history($('#bp'), $it.his.sgLength(), 0 );
            }
          });
        }
*/
...
//----------------------------------------------
    //*** Storageへ書き込む
    if( $it.checkCookie() && ($it.$storage.get($it._SG_GEAR_NAME) === '')){
...
"-moz-box-shadow:rgba(14, 27, 28, 0.33) 0px 0px 3px 3px inset;",
  ...
  $('.modal-btn2').append( '<div style="text-align:center"><img src="'+ $it._READING +'">' )
